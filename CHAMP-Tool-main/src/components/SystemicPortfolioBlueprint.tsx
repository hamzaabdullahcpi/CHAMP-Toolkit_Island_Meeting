        ...
        <svg viewBox="0 0 1000 680" className="w-full h-full text-slate-800 select-none">
          <defs>
            <marker id="arrow-solid" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto">
              <path d="M 0 0 L 10 5 L 0 10 z" fill="#3B877E" />
            </marker>
          ...
          <line x1="205" y1="365" x2="242" y2="365" stroke="#3B877E" strokeWidth="2.5" markerEnd="url(#arrow-solid)" />
          <line x1="730" y1="365" x2="772" y2="365" stroke="#3B877E" strokeWidth="2.5" markerEnd="url(#arrow-solid)" />
          ...
          <g transform="translate(265, 312)" filter="url(#card-shadow)">
            <rect width="470" height="158" rx="14" fill="#ffffff" stroke="#3B877E" strokeWidth="1.5" />
            <rect x="0" y="0" width="470" height="40" rx="14" fill="#E8F3F1" />
            <text x="235" y="25" fill="#3B877E" textAnchor="middle" fontSize="14" fontWeight="700">Collaborative Portfolio Implementation Environment</text>
            ...
            <g transform="translate(25, 72)">
              {/* Row 1 */}
              <rect x="10" y="0" width="105" height="28" rx="14" fill="#E8F3F1" stroke="#B9DED7" strokeWidth="0.8" />
              <text x="62" y="18" fill="#3B877E" textAnchor="middle" fontSize="11.5" fontWeight="600">Public agencies</text>
              
              <rect x="125" y="0" width="98" height="28" rx="14" fill="#E8F3F1" stroke="#B9DED7" strokeWidth="0.8" />
              <text x="174" y="18" fill="#3B877E" textAnchor="middle" fontSize="11.5" fontWeight="600">Governments</text>

              <rect x="233" y="0" width="92" height="28" rx="14" fill="#E8F3F1" stroke="#B9DED7" strokeWidth="0.8" />
              <text x="279" y="18" fill="#3B877E" textAnchor="middle" fontSize="11.5" fontWeight="600">Financiers</text>
              
              <rect x="335" y="0" width="75" height="28" rx="14" fill="#E8F3F1" stroke="#B9DED7" strokeWidth="0.8" />
              <text x="372" y="18" fill="#3B877E" textAnchor="middle" fontSize="11.5" fontWeight="600">Academia</text>

              {/* Row 2 */}
              <rect x="75" y="38" width="140" height="28" rx="14" fill="#E8F3F1" stroke="#B9DED7" strokeWidth="0.8" />
              <text x="145" y="56" fill="#3B877E" textAnchor="middle" fontSize="11.5" fontWeight="600">Procurement actors</text>
              
              <rect x="225" y="38" width="120" height="28" rx="14" fill="#E8F3F1" stroke="#B9DED7" strokeWidth="0.8" />
              <text x="285" y="56" fill="#3B877E" textAnchor="middle" fontSize="11.5" fontWeight="600">Civil society</text>
            </g>
          </g>
