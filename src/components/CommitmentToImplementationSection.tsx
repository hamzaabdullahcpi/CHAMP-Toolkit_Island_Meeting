  ...
  return (
    <section className="w-full max-w-6xl mx-auto mb-6">
      ...
      <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-6">
        <h2 className="font-heading text-xl md:text-2xl font-bold text-ink mb-1.5 tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr] items-stretch gap-0">
        ...
        <button
          ...
          className="text-left p-5 md:p-6 border border-line bg-surface hover:bg-paper transition-all duration-200 rounded-none flex flex-col justify-between focus:outline-none group cursor-pointer hover:border-[#3c4799] hover:shadow-xs"
        >
          <div>
            <h3 className="font-heading text-lg md:text-xl font-bold text-ink mb-2.5 leading-snug group-hover:text-[#3c4799] transition-colors">
              CHAMP Pledge
            </h3>
          ...
          <div className="pt-3 border-t border-line/60 flex items-center justify-between text-xs font-semibold text-[#3c4799]">
                ...
                <div className="flex items-center justify-between pb-2 border-b border-line">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="text-[11px] text-ink-muted hover:text-[#3c4799] cursor-pointer transition-colors"
                    >
                      Expand all
                    </button>
                  ...
                  return (
                    <div
                      ...
                      className={`border transition-all ${
                        isHighlighted
                          ? 'bg-[#3c4799]/[0.03] border-[#3c4799] shadow-xs'
                    ...
                    >
                        ...
                        <div className="flex items-start gap-3 min-w-0">
                          <span
                            className={`text-xs font-bold px-2 py-0.5 border shrink-0 mt-0.5 ${
                              isHighlighted
                                ? 'bg-[#3c4799] text-white border-[#3c4799]'
                                : 'bg-surface text-[#3c4799] border-[#3c4799]/30'
                            }`}
                          >
                            {pledge.number}
                          </span>
                          ...
                          <div>
                            <div className="flex items-center gap-2 flex-wrap">
                              <h4 className={`font-heading text-sm sm:text-base font-bold transition-colors leading-snug ${
                                isHighlighted ? 'text-[#3c4799]' : 'text-ink group-hover:text-[#3c4799]'
                              }`}>
                                {pledge.title}
                              </h4>
                              {isHighlighted && (
                                <span className="inline-flex items-center text-[10px] sm:text-[11px] font-bold text-[#3c4799] bg-[#3c4799]/15 px-2 py-0.5 border border-[#3c4799]/30">
                                  Toolkit Focus
                                </span>
                              )}
                            </div>
                      ...
                      <AnimatePresence>
                        {isExpanded && (
                          ...
                          >
                            <div className="text-xs sm:text-[13px] text-ink font-normal leading-relaxed pl-3 border-l-2 border-[#3c4799]">
                              <p className="italic text-ink/90 leading-relaxed mb-2">
                                "{pledge.fullText}"
                              </p>
                              {isHighlighted && (
                                <div className="mt-2.5 p-2.5 bg-[#3c4799]/10 border border-[#3c4799]/20 text-xs text-[#3c4799] font-medium flex items-start gap-2">
                        ...
                        <div className="space-y-1.5 min-w-0 flex-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            <h4 className={`font-heading text-base sm:text-lg font-bold transition-colors leading-snug ${
                              isPillar3 ? 'text-[#3c4799]' : 'text-ink group-hover:text-[#3c4799]'
                            }`}>
                              {pillar.title}
                            </h4>
                            {isPillar3 && (
                              <span className="inline-flex items-center text-[10px] sm:text-[11px] font-bold text-[#3c4799] bg-[#3c4799]/15 px-2 py-0.5 border border-[#3c4799]/30 shrink-0">
                              ...
                              {pillar.activities.map((act) => {
                                ...
                                return (
                                  <div
                                    ...
                                    className={`border transition-all ${
                                      isPillar3
                                        ? 'bg-paper border-[#3c4799]/30 hover:border-[#3c4799]'
                                        : 'bg-paper border-line hover:border-ink/30'
                                    }`}
                                  >
                                    <button
                                    ...
                                    >
                                      <div className="flex items-start gap-2.5 min-w-0">
                                        <span className="text-[11px] font-bold text-[#3c4799] bg-[#3c4799]/10 px-2 py-0.5 border border-[#3c4799]/20 shrink-0 mt-0.5">
                                          {act.code}
                                        </span>
                                        <span className="font-heading text-xs sm:text-sm font-bold text-ink group-hover:text-[#3c4799] transition-colors leading-snug">
                                          {act.title}
                                        </span>
                                      </div>
                                            ...
                                            {act.bullets.map((bullet, bIdx) => {
                                              ...
                                              return (
                                                <li key={bIdx} className="flex items-start gap-2">
                                                  <span className="w-1.5 h-1.5 rounded-full bg-[#3c4799] mt-1.5 shrink-0" />
                                                  <div className="flex-1">
                                                    <span>{mainText}</span>
                                                    {actor && (
                                                      <span className="ml-2 inline-block text-[11px] font-semibold text-[#3c4799] bg-[#3c4799]/10 px-1.5 py-0.2 border border-[#3c4799]/20">
                                                        [{actor}]
                                                      </span>
                                                    )}
                                                  </div>
        ...
        {activeModal === 'toolkit' && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 md:p-8">
            ...
            >
              ...
              <div className="px-6 py-5 bg-paper border-b border-line flex items-start justify-between gap-4 shrink-0">
                <div className="space-y-1">
                  <div className="text-[11px] font-bold text-[#3c4799] uppercase tracking-wider font-heading">
                    CHAMP Implementation Roadmap
                  </div>
                  <h3 className="font-heading text-lg sm:text-xl font-bold text-ink leading-snug">
              ...
              <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-1 bg-surface space-y-7">
                ...
                <div className="space-y-3 pb-6 border-b border-line/70">
                  <div className="flex items-start gap-3">
                    <span className="text-xs font-bold text-[#3c4799] bg-[#3c4799]/10 px-2 py-0.5 border border-[#3c4799]/20 shrink-0 mt-0.5 font-heading">
                      3.1
                    </span>
                      ...
                      {[1, 3, 4].map(id => {
                        ...
                        return (
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-3 py-1.5 bg-paper hover:bg-[#3c4799]/[0.06] border border-line hover:border-[#3c4799] transition-all text-left cursor-pointer group"
                          >
                            <span 
                            ...
                            <span className="text-xs font-semibold text-ink group-hover:text-[#3c4799] transition-colors">
                              {ACTION_METAS[id].title}
                            </span>
                            <ArrowRight size={12} className="text-ink-muted group-hover:text-[#3c4799] group-hover:translate-x-0.5 transition-transform shrink-0" />
                          </button>
                        );
                      })}
                    </div>
