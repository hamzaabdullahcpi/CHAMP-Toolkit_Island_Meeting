    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 md:p-10">
        ...
        >
          ...
          <div className="px-6 md:px-8 py-5 bg-paper border-b border-line flex items-start justify-between gap-4 shrink-0">
            <div>
              <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                <span className="text-[10px] sm:text-[11px] font-bold text-[#3c4799] uppercase tracking-[0.2em] bg-[#3c4799]/10 px-2.5 py-0.5 border border-[#3c4799]/30">
                  CHAMP Implementation Roadmap 2026–2028
                </span>
              </div>
              <h2 className="font-heading text-xl md:text-2xl font-bold text-ink tracking-tight">
                {pillar3.title}
              </h2>
            </div>
          ...
          <div className="px-6 md:px-8 py-3 bg-[#3c4799]/5 border-b border-[#3c4799]/15 text-xs md:text-[13px] text-ink leading-relaxed flex items-start gap-2.5 shrink-0">
            <span className="w-1.5 h-1.5 bg-[#3c4799] mt-1.5 shrink-0 rounded-full"></span>
            <p>
              ...
              return (
                <div
                  ...
                  className={`border transition-all ${
                    isTargeted
                      ? 'bg-[#3c4799]/5 border-[#3c4799] shadow-xs ring-1 ring-[#3c4799]/30'
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2.5">
                          <span className="text-[11px] font-bold text-[#3c4799] bg-[#3c4799]/10 px-2.5 py-0.5 border border-[#3c4799]/20">
                            Activity {act.code}
                          </span>
                        </div>
