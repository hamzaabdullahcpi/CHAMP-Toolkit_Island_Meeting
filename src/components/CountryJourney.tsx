    ...
    return (
      <div className="py-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-36">
        ...
        <div className="mb-10">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-[52px] text-ink leading-[1.15] font-normal tracking-tight mb-6">
            {countryData.headerTitle || `${countryData.countryName}'s Journey to Multilevel Climate Implementation`}
          </h1>

          <p className="text-lg sm:text-xl text-ink-muted font-light leading-relaxed max-w-4xl">
        ...
        <div className="p-12 bg-surface border border-line rounded-lg text-center py-24 space-y-3">
          ...
          <p className="text-sm text-ink-muted max-w-md mx-auto font-light leading-relaxed">
          ...
          >
            ...
            {countryData.premises && countryData.premises.length > 0 && (
              <div className="space-y-4">
                <h2 className="font-heading text-2xl sm:text-3xl font-medium text-ink tracking-tight">
            ...
            {countryData.contextSections && countryData.contextSections.map((section, secIdx) => (
              <div key={secIdx} className="space-y-4">
                <h2 className="font-heading text-2xl font-medium text-ink tracking-tight">
                  {section.title}
                </h2>
                
                {section.paragraphs && section.paragraphs.map((p, pIdx) => (
                  <div key={pIdx} className="text-base text-ink-muted font-light leading-relaxed space-y-2">
                    <ReactMarkdown
                      components={{
                ...
                {section.bulletPoints && section.bulletPoints.length > 0 && (
                  <ul className="space-y-2.5 pl-2 pt-1">
                    {section.bulletPoints.map((bp, bpIdx) => (
                      <li key={bpIdx} className="flex items-start gap-3 text-base text-ink-muted font-light">
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="text-base text-ink leading-relaxed font-light">
                  <ReactMarkdown
                    components={{
                      strong: ({ children }) => <strong className="text-ink font-medium">{children}</strong>,
                ...
                {countryData.modelDiagramNote && (
                  <p className="text-sm text-ink-muted leading-relaxed font-light mt-1">
                    {countryData.modelDiagramNote}
                  </p>
                )}
              </div>
                        ...
                        {isOpen && (
                          ...
                          >
                            <div className="p-6 sm:p-8 pt-0 border-t border-line/60 space-y-6">
                              <div className="text-base text-ink leading-relaxed font-light space-y-4 pt-6">
                              ...
                              {act.caseStudy && (act.caseStudy.title || (act.caseStudy.paragraphs && act.caseStudy.paragraphs.length > 0)) && (
                                <div className="mt-8 pt-6 border-t border-line/60">
                                  ...
                                  {act.caseStudy.paragraphs && (
                                    <div className="text-base text-ink-muted font-light leading-relaxed space-y-3">
