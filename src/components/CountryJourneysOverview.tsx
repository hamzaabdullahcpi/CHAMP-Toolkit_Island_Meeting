  ...
  return (
    <div className="py-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
      ...
      <div className="mb-12">
        ...
        <div className="body-text space-y-4 leading-relaxed max-w-4xl">
          ...
          {overviewContent.focusNote && (
            <p className="body-text pt-2 border-l-2 border-accent pl-4 italic bg-surface/50 py-2 rounded-none">
              {overviewContent.focusNote}
            </p>
          )}
        </div>
