...
export const ACTION_THEMES: Record<number, ActionTheme> = {
  1: {
    ...
    rgb: '60, 71, 153',
    darkHex: '#303a7a',
    bgSubtle: 'rgba(60, 71, 153, 0.04)',
    bgLight: 'rgba(60, 71, 153, 0.08)',
    bgMedium: 'rgba(60, 71, 153, 0.15)',
    borderSubtle: 'rgba(60, 71, 153, 0.20)',
    borderMedium: 'rgba(60, 71, 153, 0.40)',
    borderHover: 'rgba(60, 71, 153, 0.70)',
    badgeBg: 'rgba(60, 71, 153, 0.08)',
    badgeBorder: 'rgba(60, 71, 153, 0.25)',
    badgeText: '#3c4799',
  },
  2: {
    id: 2,
